                  ...
                  child: Column(
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        value:  _selectedEmployeeName,
                                    items: _employeeNames.map(
                                      (e) => DropdownMenuItem(value: e, child: Text(e,style: const TextStyle(fontFamily: 'Poppins',fontSize: 12),)),
                                    ).toList(),
                                    onChanged: (newValue) {
                                      setState(() {
                                        _selectedEmployeeName = newValue;
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        value:  _selectedCountryName,
                                    items: _countriesChoices.map(
                                      (e) => DropdownMenuItem(value: e, child: Text(e,style: const TextStyle(fontFamily: 'Poppins',fontSize: 14),)),
                                    ).toList(),
                                    onChanged: (newValue) {
                                      setState(() {
                                        _selectedCountryName = newValue;
