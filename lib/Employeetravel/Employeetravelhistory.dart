...
import 'package:team_c/Employeetravel/Employeetraveledit.dart';
import 'package:team_c/Employeetravel/Employeetravelhistorymodel.dart';
...
class SubmitTravelHistoryWidget extends StatefulWidget {
  const SubmitTravelHistoryWidget({super.key});

  @override
  State<SubmitTravelHistoryWidget> createState() =>
      _DocumentVisaHistoryWidgetState();
}

class _DocumentVisaHistoryWidgetState
    extends State<SubmitTravelHistoryWidget> {
  late SubmitTravelHistoryModel _model;
  final scaffoldKey = GlobalKey<ScaffoldState>();
  List<dynamic> _employeeTravel = [];
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitTravelHistoryModel());
    _fetchEmployeeTravel();
  }
  ...
  Future<void> _fetchEmployeeTravel() async {
    final token = await getAuthToken();
    final String? jwt3 = token;
    const String apiUrl = '$apiBaseUrl/hr/api/employee-travel-get';
    ...
    if (response.statusCode == 200) {
      setState(() {
        _employeeTravel = json.decode(response.body);
      });
    } else {
      // Handle error
  ...
  Future<void> _deleteEmployeeTravel(int travelId) async {
    final token = await getAuthToken();
    final String? jwt3 = token;
    final String apiUrl = '$apiBaseUrl/hr/api/delete-employee-travel/$travelId';
    ...
    if (response.statusCode == 200) {
      setState(() {
        _employeeTravel.removeWhere((visa) => visa['id'] == travelId);
      });
  ...
  Future<Map<String, dynamic>> fetchEmployeeTravelData(int travelId) async {
    final token = await getAuthToken();
  final String? jwt3 = token;
  final String apiUrl = '$apiBaseUrl/hr/api/travel-get/$travelId';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  const Expanded(
                      child: Text('Employee Travel Details',
                          style: TextStyle(
                    ...
                    children: [
                      IconButton(
                        icon: Padding(
                          ...
                          child: Icon(
                            Icons.edit_outlined,
                            color: employeeData['employeetravel_status'] == 'approved' || employeeData['employeetravel_status'] == 'rejected'
                        ...
                        onPressed: () async {
                          ...
                          if (employeeData['employeetravel_status'] != 'approved' && employeeData['employeetravel_status'] != 'rejected') {
                            Navigator.push(context,
                              MaterialPageRoute(
                                builder: (context) => TravelupdateWidget(
                                   employeetravel    : employeeData,
                                ),
                              ),
                            );
                          }
                                  ...
                                  actions: <Widget>[
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        ...
                                        _deleteEmployeeTravel(medicalReportId);
                                      },
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.select_all, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.visibility, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['travel_start_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.offline_pin, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['country_of_travel']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.cached_sharp, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['entity_company_traveling_for']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.request_page, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['advance_amount_required']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.currency_exchange_outlined, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.add_card, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['visa_to_be_processed']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.hotel_sharp, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['book_hotel_accommodation']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.airplane_ticket_outlined, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['flight_ticket_required']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.note_alt_outlined, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['visa_letter_required']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['employeetravel_status']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['employeetravel_applied_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                      ...
                      child: Container(
                        ...
                        child: PaginatedDataTable(
                          ...
                          source: MedicalDataTableSource(
                            medicalApplications: _employeeTravel,
                            onDelete: (index) {
                              final medicalReport = _employeeTravel[index];
                              _deleteEmployeeTravel(medicalReport['id']);
                            },
                            onTapDetails: (index) {
                              final medicalReport = _employeeTravel[index];
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(
      cells: [
        ...
        DataCell(
          Text(
            medicalReport['employeetravel_status'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
          Text(
            medicalReport['employeetravel_applied_date'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
