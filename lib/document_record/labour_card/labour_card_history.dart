...
import 'package:team_c/document_record/labour_card/labour_card_history_model.dart';
import 'package:team_c/document_record/labour_card/labour_card_update.dart';
...
class DocumentLabourHistoryWidget extends StatefulWidget {
  const DocumentLabourHistoryWidget({super.key});

  @override
  State<DocumentLabourHistoryWidget> createState() =>
      _DocumentLabourHistoryWidgetState();
}

class _DocumentLabourHistoryWidgetState
    extends State<DocumentLabourHistoryWidget> {
  late DocumentLabourHistoryModel _model;
  final scaffoldKey = GlobalKey<ScaffoldState>();
  List<dynamic> _documentLabour = [];
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocumentLabourHistoryModel());
    _fetchDocumentLabour();
  }
  ...
  Future<String?> getAuthToken() async {
   ...
   Future<void> _fetchDocumentLabour() async {
    final token = await getAuthToken();
    final String? jwt3 = token;
    const String apiUrl = '$apiBaseUrl/hr/api/labour-card-get';
  ...
  final response = await http.get(
    ...
    if (response.statusCode == 200) {
      setState(() {
        _documentLabour = json.decode(response.body);
      });
    } else {
      // Handle error
      print('Failed to fetch Document Labour: ${response.statusCode}');
    }
  }

 Future<void> _deleteDocumentLabour(int LabourId) async {
  final token = await getAuthToken();
  final String? jwt3 = token;
  final String apiUrl = '$apiBaseUrl/hr/api/delete-document-labourcard/$LabourId';
  ...
  if (response.statusCode == 200) {
    ...
    setState(() {
      _documentLabour.removeWhere((Labour) => Labour['id'] == LabourId);
    });
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Failed to delete Labour'),
      ),
    );
  }
}
  Future<Map<String, dynamic>> fetchVisaData(int visaId) async {
    final token = await getAuthToken();
  final String? jwt3 = token;
  final String apiUrl = '$apiBaseUrl/hr/api/labour-card-get/$visaId';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  const Expanded(
                      child: Text('Document Labour Card Details',
                          style: TextStyle(
                    ...
                    children: [
                      IconButton(
                        icon: Padding(
                          ...
                          child: Icon(
                            Icons.edit_outlined,
                            color: employeeData['labourContract_status'] == 'approved' || employeeData['status'] == 'rejected'
                        ...
                        onPressed: () async {
                          ...
                          print('Fetched data of Labour Card: $fetchedData');
                          if (employeeData['documentForlabourcard_status'] != 'approved' && employeeData['documentForlabourcard_status'] != 'rejected') {
                            Navigator.push(context,
                              MaterialPageRoute(
                                builder: (context) => CreateRecordForLabourCardEditWidget(
                      ...
                      IconButton(
                        icon: Padding(
                          ...
                          child: Icon(
                            ...
                            color: employeeData['documentForlabourcard_status'] == 'approved' || employeeData['documentForlabourcard_status'] == 'rejected'
                                ? const Color.fromARGB(255, 229, 111, 111)
                                : FlutterFlowTheme.of(context).primaryText,
                            size: 24,
                          ),
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: const Text('Are you sure you want to delete this Document Labour?'),
                                  actions: <Widget>[
                                    TextButton(
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        ...
                                        _deleteDocumentLabour(medicalReportId);
                                      },
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardcountry_name']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCarddocument_type']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardcategory']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCarddocument_number']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardissued_by']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardissued_at']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardissued_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardissuing_authority']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardvalid_from']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardvalid_to']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardverified_by']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['LabourCardverified_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(right: 8.0),
                            child: Icon(Icons.format_list_numbered_outlined, color: Colors.black, size: 16),
                          ),
                          Expanded(
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['aly_personal_id_number']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['aly_work_permit_number']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['aly_place_of_issue']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['documentForlabourcard_status']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 12, 0),
                                    child: Text(
                                      '${employeeData['documentForlabourcardApplied_date']}',
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                        fontFamily: 'Readex Pro',
                                        letterSpacing: 0,
                                        fontSize: 15,
                    ...
                    child: Container(
                      ...
                      child: PaginatedDataTable(
                        ...
                        source: MedicalDataTableSource(
                          medicalApplications: _documentLabour,
                          onDelete: (index) {
                            final medicalReport = _documentLabour[index];
                            _deleteDocumentLabour(medicalReport['id']);
                          },
                          onTapDetails: (index) {
                            final medicalReport = _documentLabour[index];
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(
      cells: [
        ...
        DataCell(
          Text(
            medicalReport['documentForlabourcard_status'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
          Text(
            medicalReport['documentForlabourcardApplied_date'].toString(),
            style: const TextStyle(fontFamily: 'Readex pro'),
          ),
        ),
        DataCell(
